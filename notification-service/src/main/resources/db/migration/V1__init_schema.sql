-- pickbit_notification_server 초기 스키마.
...
CREATE TABLE `notification` (
  ...
  `target_type` enum('AUCTION','PAYMENT','PRODUCT') COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('AUCTION_WON','PAYMENT_CANCELLED_BEFORE_PAYMENT','PAYMENT_ESCROWED','PAYMENT_FAILED_NO_PAYMENT','PAYMENT_REFUNDED','PAYMENT_SETTLED') COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
